<template>
  <v-container>
    <template>
      <v-card>
        <v-card-title> Bouwplan 2023 </v-card-title>
        <v-card-subtitle>
        ...
        <v-card-text>
          <v-row v-if="userIsAdmin">
            <v-col>
              <v-file-input v-model="files" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                placeholder="Selecteer bouwplan excel" prepend-icon="mdi-microsoft-excel" outlined dense></v-file-input>
              <v-btn :disabled="!this.fileSelected" color="primary" outlined @click="uploadBouwplan">Uploaden</v-btn>
            </v-col>
          </v-row>
