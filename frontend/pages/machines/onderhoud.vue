<template>
  <v-container>
    ...
    <EditMachineMaintenanceIssueDlg ref="editMachineMaintenanceIssue" @save="save($event)" @saveEdit="saveEdit($event)" />
    ...
    <section>
      <v-data-table :search="search" :headers="userHasRole(['admin', 'monteur']) ? headersAdmin : headers"
        :sort-by="['created_at']" show-expand :sort-desc="[true]" :items="filteredMaintenanceIssues" class="elevation-1">
