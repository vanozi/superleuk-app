...
const address: IAddress = ref(Object.assign({}, props.user.address));
...
<template>
  <div class="q-ma-md">
    <q-form>
      <q-input v-model="address.street" label="Straat" lazy-rules :readonly="readonly" />
      <q-input v-model="address.number" label="Huisnnummer" lazy-rules :readonly="readonly" />
      <q-input v-model="address.postal_code" label="Postcode" lazy-rules :readonly="readonly" />
      <q-input v-model="address.city" label="Stad" lazy-rules :readonly="readonly" />
      <q-input v-model="address.country" label="Land" lazy-rules :readonly="readonly" />
    </q-form>
